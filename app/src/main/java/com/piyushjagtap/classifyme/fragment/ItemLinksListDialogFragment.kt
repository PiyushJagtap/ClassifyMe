 ...
 * <pre>
 *    ItemLinksListDialogFragment.newInstance(30).show(supportFragmentManager, "dialog")
 * </pre>
 */
class ItemLinksListDialogFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(
            R.layout.fragment_item_links_list_dialog_list_dialog,
            container,
            false
        )
    }
    ...
    private inner class ViewHolder internal constructor(
        ...
        inflater.inflate(
            R.layout.fragment_item_links_list_dialog_list_dialog_item,
            parent,
            false
        )
    ) {
